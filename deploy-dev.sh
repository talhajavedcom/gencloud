...
_front_end_url="https://genclouds-dev.theexpertscloud.com" # This is also available in .env.dev
_remote="3.228.101.116"
_user="ubuntu"
_remote_directory_name="genclouds-dev"


echo "❗❗❗ Genclouds Dev Frontend Deployment ❗❗❗"
